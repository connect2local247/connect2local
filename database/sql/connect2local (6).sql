...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 21, 2024 at 03:11 PM
...
(1, 'Bhavesh Parmar', 'eN1HuePtg3ql8iSmjrRQUm1oN2Vwa2RHVUhhbjVHOGRzSkhTMFhSUjBUT3NVS1dnL3JKMW5hbEVsNFE9', 'aS14DjR2TSmcA4ylQQa2j2FWZE1zSURkL21ZcG9ZVnFac3pVR2c9PQ==', 917258, '$2y$10$dy2eLGg8gBo7.e97LvHZlORCYdoslgpZ8bkaNeJUtnc1vBEvubkdi');
...
CREATE TABLE IF NOT EXISTS `blog_report` (
  ...
  `blg_id` varchar(10) NOT NULL,
  `reporter_user_id` varchar(10) NOT NULL,
  `bp_user_id` varchar(10) NOT NULL,
  `report_content` varchar(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `business_verification` (
  ...
  `two_step_status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`b_key`),
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `blg_id` varchar(10) NOT NULL,
  `commentor_id` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `customer_verification` (
  ...
  `c_verification_code` varchar(6) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `follower_data`;
CREATE TABLE IF NOT EXISTS `follower_data` (
  `fd_user_id` varchar(10) NOT NULL,
  `fd_follower_id` varchar(10) NOT NULL,

<?php
        ...
        function check_exist_contact($contact){
            if(find_encrypted_data($contact,"customer_register","customer_verification","C_ID","C_CONTACT","C_KEY","C_ID")){
                return true;
            }
        }
        ...
        function store_data($fname,$lname,$birth_date,$age,$gender,$contact,$email,$password,$confirm_password){

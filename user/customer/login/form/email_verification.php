...
<body id="form-body" style="height:100vh;width:100%">
        ...
        <form action="/user/customer/login/code/user_verification_code.php" method="POST" class="d-flex flex-column justify-content-center align-items-center p-2" style="height:90vh;width:100%;">
            ...
            <fieldset class="border border-light p-4 rounded-2 text-white col-lg-5 col-md-9 col-12" id="register-form">
                ...
                <div class="mt-2 d-flex justify-content-end px-2">
                    <a href="/user/customer/login/code/resend-code.php?resend_code=1" class="nav-link text-white">Resend Code</a>
                </div>

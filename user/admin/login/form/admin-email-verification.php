...
<body id="form-body" style="height:100vh;width:100%">
        ...
        ?>
        <form action="/user/admin/login/code/email_verification_check.php" method="POST" class="d-flex flex-column justify-content-center align-items-center p-2" style="height:90vh;width:100%;">
            ...
            <fieldset class="border p-4 rounded-2 text-white col-lg-5 col-md-9 col-12" id="register-form">
                ...
                <div class="mt-4 d-flex justify-content-center">
                    <input type="submit" name="submit" value="Submit" id="register-btn" class="btn border text-bg-primary bg-gradient py-2 px-5 rounded-pill" >
                </div>
            </fieldset>
        </form>

...
<script>
        ...
        ?>
        <form action="/user/admin/login/code/login-validation.php" method="post" class="d-flex flex-column align-items-center justify-content-center p-2" style="height:90vh;width: 100%;">
            <fieldset class="p-3 border rounded col-lg-7 col-md-10 col-12 text-white" id="register-form">
                ...
                <div class="mt-3">
                    ...
                    <input type="email" name="email" class="form-control border border-dark border-2 py-2" id="email" placeholder="Email Address" required>
                </div>

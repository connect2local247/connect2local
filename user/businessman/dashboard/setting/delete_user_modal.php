  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content text-bg-dark">
      ...
      <div class="modal-body">
        <?php
            $sql = "SELECT br.b_email AS email, br.b_password AS password, bv.b_key AS verification_key
            FROM business_register AS br
            INNER JOIN business_verification AS bv ON br.b_id = bv.b_id
            WHERE br.b_id = '$current_user_id'";
...
$(document).ready(function(){
    $('#submitSecondModal').on('click', function(e){
        ...
        window.location.href = "/user/businessman/dashboard/dashboard.php?content=dashboard&delete_status=1&current_user_id=<?php echo $current_user_id ?>";
    });
});
</script>
      </div>

  ...
  <div class="accordion" id="accordionExample">
    <div class="card">
      <div class="card-header" id="headingOne">
        <h2 class="mb-0">
          <button class="btn  m-auto d-flex text-dark fw-semibold" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            Activitiy
          </button>
        </h2>
      </div>
...
if(isset($current_user_id)) {
    $get_verification_status = "SELECT two_step_status FROM business_verification WHERE b_id = '$current_user_id'";
    ...
    if(isset($_GET['security_status'])) {
      if($_GET['security_status'] == 1){
        if($two_step_enabled == 0){
          $update_query = "UPDATE business_verification SET two_step_status = 1 WHERE b_id = '$current_user_id'";
        } else{
          $update_query = "UPDATE business_verification SET two_step_status = 0 WHERE b_id = '$current_user_id'";
        }
        ...
        echo "<script>location.href='/user/businessman/dashboard/dashboard.php?content=setting'</script>";
        }
    }
}
?>
...
<div class="card">
    <div class="card-header" id="headingFive">
        <h2 class="mb-0">
            <button class="btn  m-auto d-flex text-dark fw-semibold collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                Security
            </button>
        </h2>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    checkbox.addEventListener("change", function() {
        location.href = "/user/businessman/dashboard/dashboard.php?content=setting&security_status=1";
    });
});
</script>
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <h2 class="mb-0">
        <button class="btn  m-auto d-flex text-dark fw-semibold collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" onclick = "location.href='/webpage/help/help.php'">
          Help
        </button>
      </h2>
    </div>
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <h2 class="mb-0">
        <button class="btn  m-auto d-flex text-dark fw-semibold collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" onclick="location.href='/webpage/about/about.php'">
          About Us
        </button>
      </h2>
    </div>

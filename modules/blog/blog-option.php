...
<!-- 
                                ...
                                <li class="list-item mt-2 shadow border p-2 rounded d-flex align-items-center justify-content-center"><i class="fa-solid fa-ban fs-5" data-bs-toggle="modal" data-bs-target="#blockModal<?php echo $unique_identifier ?>"></i>&nbsp;Block</li>
